    const SwimLessonCalendar = ({ preselectedType, preselectedPool, autoBookWeekly, bookedLessons, setBookedLessons, saveLessons, cancelledLessons, isDateBlocked, getFirstAvailableDate, getClosestAvailableTo, dateWindowEnd, lessonTypeUpdate, weekdayTimeSettings, dateTimeSettings, pools, poolSettings }) => {
        ...
        useEffect(() => {
            if (preselectedPool) {
                ...
                handlePoolChange(preselectedPool);
            }
        }, [preselectedPool]);
